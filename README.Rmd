...
+ Using the RStudio Cloud Workspace: All material is available in the conference workspace.  We will send a link to the workspace, via the registered email address of attendees, in the week prior to the conference.
...
Please commit you workshop material to a GitHub repository by 30/10/2019.  This will allow us time to make sure your material is available on RStudio cloud.  Please email a link to your repository, and a list of the required `R` packages, to [nhsrconfspeakers@gmail.com](mailto:nhsrconfspeakers@gmail).
