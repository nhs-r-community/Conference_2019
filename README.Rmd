...
+ Using your own machine: You can download zip files of each workshop, or if you are familiar with Git and GitHub, you can clone the repository.
+ Using the RStudio Cloud Workspace: All material is available in the ___[link to follow]___. Please email ___[email to follow]___, prior to the conference to request access.
...
Please commit you workshop material to a GitHub repository by 30/10/2019.  This will allow us time to make sure your material is available on RStudio cloud.  Please email a link to your repository, and a list of the required `R` packages, to nhsrconfspeakers@gmail.com.
...
You can fine the package at: https://github.com/nhs-r-community/NHSRdatasets
